...
pagerank_dic = nx.pagerank(G)    #Calculate the Pagerank of the network which will return a dictionary 
with open("Pagerank_Output.txt","w") as f:    #Create a text file name Pagerank_Output 
