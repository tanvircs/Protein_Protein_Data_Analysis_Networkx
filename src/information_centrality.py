...
information_centrality_dic = nx.information_centrality(G)    #Calculate the Information Centrality of the network which will return a dictionary 
with open("Information_Centrality_Output.txt","w") as f:    #Create a text file name Current Information_Centrality_Output 
    f.write("\t\t\t\t\t\t\t\t\t************************************\t\t\tInformation Centrality Output\t\t\t************************************"+"\n")
     #Write a header title 
    for k,v in information_centrality_dic.items():   #Iterate into the dictionary
